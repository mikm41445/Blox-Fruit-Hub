...
function Blacklib:Window()
    ...
    BlackImage.Image = "rbxassetid://17421580622"
    ...
    spawn(function()
        while task.wait() do
            titlefunc:Refresh("") wait(.2) titlefunc:Refresh("W") wait(.2) titlefunc:Refresh("Wil") wait(.2) titlefunc:Refresh("Wil") wait(.2) titlefunc:Refresh("Will") wait(.2) titlefunc:Refresh("William") wait(.2) titlefunc:Refresh("Will") wait(.2) titlefunc:Refresh("Wil") wait(.9) titlefunc:Refresh("Wi") wait(.2) titlefunc:Refresh("W") wait(.2) titlefunc:Refresh("") wait(.2) wait(.3)
        end
    end)
    -- End Windows --
...
local ui = Blacklib:Window("WILLIAM X")
...
game.StarterGui:SetCore("SendNotification", {
        Title = "WILLIAM X HUB"; -- the title (ofc)
        Text = "Mirage not Found!"; -- what the text says (ofc)
        Icon = "rbxassetid://17421580622"; -- the image if u want. 
